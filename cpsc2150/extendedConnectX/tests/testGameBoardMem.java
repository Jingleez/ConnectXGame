...
public class testGameBoardMem {
    ...
    public void testConstructorCase2() {
        IGameBoard gb = GameBoardFactory.makeGameBoard(5, 5, 4);
        assertNotNull(gb);
    ...
    public void testConstructorCase3() {
        IGameBoard gb = GameBoardFactory.makeGameBoard(1, 1, 1);
        assertNotNull(gb);
...
// Test case 1 - Horizontal win in the first row
    ...
    public void testCheckHorizWinCase3() {
        IGameBoard gb = GameBoardFactory.makeGameBoard(4, 4, 3);
        gb.dropToken('X', 0);
        gb.dropToken('O', 1);
        gb.dropToken('X', 1);
        gb.dropToken('O', 2);
